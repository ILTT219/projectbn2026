...
export default function ProductsPage() {
  ...
  return (
    <div className="container-custom py-10 min-h-screen">
      ...
      <div className="flex flex-col md:flex-row items-center justify-between mb-[50px] mt-[140px] md:mt-[100px] min-h-[100px] w-full gap-[10px] md:gap-0">
      ...
      <div className="mt-6">
        ...
        {layout === 'list' && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {filtered.map((p) => (
              <Link key={p.id} href={`/products/${p.id}`} className="block group">
                <div className="flex gap-[10px] bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md border border-slate-100 transition-all group-hover:border-brand-green">
